...
import { useDeleteRevisionSingleImageMutation } from '@/redux/services/revisionApi';

const RevisionImageShow = ({ images, imageSource, setImages }) => {
  const [deleteImage] = useDeleteRevisionSingleImageMutation();
...
export default RevisionImageShow;
