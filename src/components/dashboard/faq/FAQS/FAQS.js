  ...
  const faqs = [
    {
      ...
      description:
        'Just signup and select services you required. Then upload file with instruction on Upload section in dashboard.',
    },
    {
      title: 'Do You Offer A Free Trial ?',
      description:
        'We have $20 free trial credit. You can try our service for free. No credit card required!',
    },
    {
      title: 'What Services Do You Offer ?',
      description:
        'We are Offering Product photo Retouching, Model Photo Retouching, Clipping Path, Background removal and many more.',
    },
    {
      title: 'How Do I Pay ?',
      description:
    ...
    },
    {
      ...
      description:
        'You can signup and upload your files to our secured server or you can attach your file link.',
    },
    {
      title: 'What Is The Pricing Per Image',
      description:
        'Our Stating price is $0.30/photo for more details please visit our pricing page.',
    },
    {
      title: 'Do You Have Any Revision?',
      description:
        'Yes, Of course. If you do not like retouching style you can always ask for revisions. We will do it without any extra charege.',
    },
  ];
